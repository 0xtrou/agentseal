...
#[derive(Debug, Parser)]
#[command(name = "snapfzz-seal-server")]
struct Cli {
    #[arg(long = "bind", default_value = "127.0.0.1:9090")]
    bind: String,

    #[arg(long = "compile-dir", default_value = "./.snapfzz-seal/compile")]
    compile_dir: PathBuf,

    #[arg(long = "output-dir", default_value = "./.snapfzz-seal/output")]
    output_dir: PathBuf,
}
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    tracing::info!("snapfzz-seal-server listening on {}", bind_addr);
